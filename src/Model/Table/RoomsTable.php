 ...
 * Rooms Model
 *
 * @property \App\Model\Table\RoomMembersTable|\Cake\ORM\Association\HasMany $RoomMembers
 * @property \App\Model\Table\WhispersTable|\Cake\ORM\Association\HasMany $Whispers
 *
...
class RoomsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->hasMany('RoomMembers', [
            'foreignKey' => 'room_id'
        ]);
        $this->hasMany('Whispers', [
            'foreignKey' => 'room_id'
        ]);
    }
